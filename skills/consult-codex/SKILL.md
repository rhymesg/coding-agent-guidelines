---
name: consult-codex
description: "Use when your answer contains several options without a clear winner, when your conclusion is uncertain or rests on claims you could not verify, or when reviewing a finished document or code change — gets an independent pass from Codex."
---
...
3. When the user asks for fixes, have Codex apply them: resume the same thread with `--resume --write`.
