...
5. Documentation: check Doxygen comments and generated documents against the project's Doxygen guidelines and fix the findings. Then review and update `docs/` and `README.md` following the `document-writing-guidelines` and `sync-docs` skills.
